...
public class RouteActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng dalton = new LatLng(37.136873, -80.549434);
        LatLng the_bonnie = new LatLng(37.136754, -80.548136);
        LatLng peery = new LatLng(37.136967, -80.548882);
        ...
        campus_locations.put("MF | Moffett Hall", moffett);
        campus_locations.put("DR | Draper Hall", draper);
        campus_locations.put("IN | Ingles Hall", ingles);
        campus_locations.put("BH | Bolling Hall", bolling);
        campus_locations.put("PC | Pocahontas Hall", pocahontas);
        campus_locations.put("DH | Dalton Hall", dalton);
        campus_locations.put("PY | Peery Hall", peery);
        campus_locations.put("FL | Floyd Hall", floyd);
        campus_locations.put("WC | Waldron College Hall", waldron);
        campus_locations.put("CK | Cook Hall", cook);
        campus_locations.put("WA | Washington Hall", washington);
        campus_locations.put("NP | Norwood Plaza", norwood);
        campus_locations.put("JF | Jefferson Hall", jefferson);
        campus_locations.put("MA | Madison Hall", madison);
        campus_locations.put("TY | Tyler Hall", tyler);
        campus_locations.put("Muse", muse);
        campus_locations.put("HB | College of Humanities and Behavioral Sciences", CHUBS);
        campus_locations.put("Preston", preston);
        campus_locations.put("CC | Covington Center", covington);
        campus_locations.put("BU | Buchanan House", buchanan);
